    ...
    return (
        <section className="py-16 bg-black border-y border-white/5 overflow-hidden relative z-10">
            <div className="container mx-auto px-6 mb-8 text-center">
                <p className="text-gray-500 uppercase tracking-widest text-sm font-bold">Ils nous font confiance</p>
            </div>
                ...
                >
                    {allLogos.map((logo, i) => (
                        <div key={i} className="flex-shrink-0 grayscale hover:grayscale-0 transition-all duration-300 opacity-50 hover:opacity-100">
                            ...
                            <img src={logo} alt="Client Logo" className="h-8 md:h-10 object-contain brightness-0 invert" />
                        </div>
                    ))}
                </motion.div>
            </div>
