                ...
                {showQrCode && (
                    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
                        ...
                        >
                            ...
                            <div className="bg-white p-4 rounded-2xl inline-block mx-auto mb-6 relative">
                                <OptimizedImage
                                    src={`https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=${encodeURIComponent(typeof window !== 'undefined' ? window.location.href : '')}&bgcolor=111&color=fff&margin=10`}
                                    alt="QR Code"
                                    width={192}
                                    height={192}
                                    className="w-48 h-48"
